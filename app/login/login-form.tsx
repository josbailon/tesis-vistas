...
export function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-blue-50 to-green-50">
      <div className="w-full max-w-5xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-3">Clínica Dental ULEAM</h1>
          <p className="text-xl text-gray-600">Sistema de Gestión Odontológica</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-t-lg">
              ...
              <CardDescription className="text-green-100">Accede directamente con un rol específico</CardDescription>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-4">
                {quickAccessUsers.map((user) => (
                  <Button
                    ...
                    className={`w-full justify-start text-left h-16 ${user.color} text-white shadow-lg hover:shadow-xl transition-all duration-200`}
                    disabled={isLoading}
                    variant="default"
                  >
                    <user.icon className="mr-4 h-6 w-6" />
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-blue-200">
                <h3 className="font-semibold text-blue-900 mb-3">Información del Sistema</h3>
